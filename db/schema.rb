...
ActiveRecord::Schema.define(version: 2019_04_05_022422) do
  ...
  create_table "tasks", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC", comment: "タスクを管理するためのテーブル", force: :cascade do |t|
